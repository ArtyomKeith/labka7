...
if not filtered_data.empty:
    ...
    st.markdown("""
    ## Описание графика
    Данный график показывает изменение продовольственной безопасности в разных странах Центральной Азии за период с 2014 по 2017 годы.
    Обратите внимание на различные тенденции в зависимости от выбранной страны.
    Вы можете выбрать страны для сравнения, и график будет обновлен автоматически.
    """)
